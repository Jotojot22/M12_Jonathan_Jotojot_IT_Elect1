...
const contacts = [
    ...
    },
    {
        ...
        name: 'Ryan Mipaña',
        messages: [
  { text: 'pre!', sender: '5:18 pm' },
  { text: 'asaa ka!', sender: '5:21 pm' },
  { text: 'nahuman nakas ass.?', sender: '5:22 pm' },
  { text: 'send pre mwhehe', sender: '5:23 pm' },
        ],
    },
    {
         id: '3',
        name: 'Julie Smith Nadal',
        messages: [
  { text: 'pre, dia kos secret place', sender: '4:00 pm' },
  ...
  { text: 'ky murag madugay mi', sender: '4:50 pm' },
    ...
    },
    {
        ...
        name: 'Shoppe',
        messages: [
  { text: 'Huyyy sir', sender: '5:00 pm' },
  { text: 'nag sale nag otwoo', sender: '5:00 pm' },
  { text: '500 na sir', sender: '5:05 pm' },
  { text: 'orderrr nataaaa', sender: '5:05 pm' },
  { text: 'sir ga orderr nko!!', sender: '5:06 pm' },
